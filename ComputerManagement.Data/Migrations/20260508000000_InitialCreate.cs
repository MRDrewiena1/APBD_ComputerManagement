        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "AMD", "Advanced Micro Devices, Inc.", new DateOnly(1969, 5, 1) },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Gaming Beast X", 12.5f, 36, new DateTime(2026, 5, 8, 9, 0, 0, 0, DateTimeKind.Unspecified), 5 },
                    { 2, "Office Mini Pro", 4.2f, 24, new DateTime(2026, 4, 15, 13, 30, 0, 0, DateTimeKind.Unspecified), 12 },
                    { 3, "Workstation Ultra", 18.0f, 48, new DateTime(2026, 3, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), 3 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "I9-14900K", "Intel Core i9-14900K", "High-end desktop processor", 1, 1 },
                    { "RTX4090  ", "NVIDIA GeForce RTX 4090", "Top-tier gaming GPU", 3, 2 },
                    { "DDR5-32GB", "32GB DDR5 RAM", "High-speed memory module", 2, 3 }
                });
